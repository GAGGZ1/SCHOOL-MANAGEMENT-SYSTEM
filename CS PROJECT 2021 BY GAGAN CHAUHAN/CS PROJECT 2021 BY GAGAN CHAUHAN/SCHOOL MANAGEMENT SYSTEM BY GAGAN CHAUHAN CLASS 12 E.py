...
def deaf():
    ...
    c.execute("insert into deafaultstudent(name,class,roll_no,address,phone) values('{}',{},{},'{}',{})".format('raj kapoor',12,10,'rdr',233455))
    c.execute("insert into deafaultstudent(name,class,roll_no,address,phone) values('{}',{},{},'{}',{})".format('jatin kalra',12,1,'dineshpur',238655))
    ...
    l=int(input("class :"))
    r=int(input("Roll no:"))
    k="delete from deafaultstudent where roll_no={} and class={}".format(r,l)
    c.execute(k)
    con.commit()
...
def ast():
    ...
    k="insert into student(class,roll_no,phone,name,address) values({},{},{},'{}','{}')".format(n,p,ph,m,d)
    c=con.cursor()
    c.execute(k)
    con.commit()
...
def addt():
    ...
    k="insert into teacher(name,post,salary,address,phone,acno) values('{}','{}',{},'{}',{},{})".format(n,c,r,a,p,m)
    c=con.cursor()
    c.execute(k)
    con.commit()
...
def abclass():
    ...
    sql="insert into cattendence values({},'{}','{}',{},'{}')".format(y,m,d,cl,ab)
    c=con.cursor()
    c.execute(sql)
    con.commit()
...
def abteacher():
    ...
    sql="insert into tattendence values({},'{}','{}','{}')".format(y,m,d,ab)
    c=con.cursor()
    c.execute(sql)
    con.commit()
...
def submitf():
    ...
    f=int(input("fees:"))
    d=int(input("date:"))
    sql="insert into fees values('{}',{},'{}','{}',{},{})".format(n,c,r,m,f,d)
    c=con.cursor()
    c.execute(sql)
    con.commit()
